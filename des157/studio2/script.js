    ...
    for(let image of images){
        image.addEventListener('click', function(event){
            ...
            switch(event.target.id){
                case 'img1':
                    imageDesc.innerHTML = 'This photo was taken at the Hare Creek Bridge in Fort Bragg. Under the bridge is a small beach. You can sit here and feel the spray of the water as it laps against the rocks!';
                    break;
                case 'img2':
                    ...
                    break;
                case 'img3':
                    imageDesc.innerHTML = 'This photo was taken at Lake Elizabeth as well, though the bridge is a new addition to the park. A walk along this bridge will give you plenty of time to enjoy the fresh air and the view of the lake!';
                    break;
                case 'img4':
                    ...
                    break;
                case 'img5':
                    imageDesc.innerHTML = 'Taken near Bellagio, Las Vegas, this photo of a bright fountain shows us what the neon capital is all about! Myth, magic, and a hint of red wine will draw you in as you walk along this famous strip.';
                    break;
                case 'img6':
                    imageDesc.innerHTML = 'Taken at Las Vegas, Nevada, this photo shows what the heart of the city looks like at night. With the lively music and people, you won\'t ever get bored. It\'s a must visit for lovers of bright city lights!';
                    break;
                case 'img7':
                    imageDesc.innerHTML = 'Taken at the San Francisco Exploratorium, this photo shows the excited sea on a windy afternoon. Come here to enjoy a grilled cheese while watching the waves - but don\'t forget to bring a sweater!';
                    break;
                default:
